...
Sitemap generation also excludes every known permanent-redirect path. This keeps legacy URLs usable as redirects without presenting redirecting aliases to search engines as indexable destinations.
