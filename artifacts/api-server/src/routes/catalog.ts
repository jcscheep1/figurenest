...
export const catalogTools: CatalogTool[] = [
  ...
  { slug: "cable-fuse-size", name: "Cable & Fuse Size Calculator", description: "Estimate cable size, protective-device rating, design current, and voltage drop for common low-voltage circuits.", category: "Electrical", categorySlug: "electrical", href: "/calculators/electrical/cable-fuse-size", tags: ["cable size", "wire size", "fuse size", "breaker size", "electrical cable", "voltage drop", "230v", "400v"], featured: true, lastUpdated: CATALOG_LAST_UPDATED },
  {
    slug: "vat",
    name: "VAT Calculator",
