...
export const fileToolDefinitions = {
  'pdf-sign-edit': {
    slug: 'pdf-sign-edit',
    name: 'PDF Sign & Edit',
    description: 'Sign, fill and annotate a PDF with text, signatures, highlights, freehand drawings, images and reviewed stamps, then download the edited copy without uploading the document.',
    category: FILE_TOOLS_CATEGORY.name,
    categorySlug: FILE_TOOLS_CATEGORY.slug,
    href: '/file-tools/pdf-sign-edit',
    tags: ['sign pdf', 'edit pdf', 'annotate pdf', 'highlight pdf', 'add image to pdf', 'add signature to pdf', 'fill pdf', 'pdf signer', 'pdf editor', 'private pdf tool'],
    featured: false,
    h1: 'Sign & Edit a PDF Online',
    seoTitle: 'Free PDF Sign, Edit & Annotate Tool | Private Browser | FigureNest',
    seoDescription: 'Sign and edit a PDF in your browser. Add text, signatures, highlights, freehand drawings, images and stamps, then export without uploading the document.',
    privacySummary: 'Your PDF is processed in this browser tab. FigureNest does not upload the document, its name, its extracted contents, signatures, added images, annotations, or the edited result.',
    limitations: [
      'The editor supports fill-and-sign marks, highlights, freehand drawings, PNG/JPEG images and a small reviewed stamp set. Page rotation, reordering and deletion are planned as a separate page-operations release.',
    ...
    faqs: [
      ...
      { question: 'Can I undo annotations and image changes?', answer: 'Yes. Additions, moves, resizes, text edits and deletions are kept in an in-memory undo and redo history for the current document, including highlights, freehand drawings, images and stamps.' },
