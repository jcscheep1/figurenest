...
const slab: ConcreteCalculatorContent = {
  ...
  examples: [
    { title: 'Garage floor slab', inputs: 'Length 20 ft; width 12 ft; thickness 4 in; waste 10%', inputValues: { length: 20, width: 12, depth: 4, waste: 10 }, unit: 'imperial', expectedRaw: 3.259259, working: '20 × 12 × (4 ÷ 12) ÷ 27 × 1.10', result: '3.26 yd³ to order (2.96 yd³ base)', interpretation: 'The estimate models one uniform 4-inch slab and does not include thickened edges or footings.' },
...
const footing: ConcreteCalculatorContent = {
  ...
  examples: [
    { title: 'Continuous strip footing', inputs: 'Run length 48 ft; width 16 in; depth 8 in; count 1; waste 10%', inputValues: { length: 48, width: 16, depth: 8, count: 1, waste: 10 }, unit: 'imperial', expectedRaw: 1.738272, working: '48 × (16 ÷ 12) × (8 ÷ 12) ÷ 27 × 1 × 1.10', result: '1.74 yd³ to order', interpretation: 'Count stays at one because 48 ft is already the complete length of this modeled run.' },
    { title: 'Six identical short runs', inputs: 'Run length 8 ft; width 12 in; depth 8 in; count 6; waste 5%', inputValues: { length: 8, width: 12, depth: 8, count: 6, waste: 5 }, unit: 'imperial', expectedRaw: 1.244444, working: '8 × 1 × (8 ÷ 12) × 6 ÷ 27 × 1.05', result: '1.24 yd³ to order', interpretation: 'Count six means six separate runs, each 8 ft long with exactly the entered cross-section.' },
  ],
