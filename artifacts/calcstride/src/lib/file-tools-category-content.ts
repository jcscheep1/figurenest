...
export const fileToolsCategoryContent: CategoryContent = {
  introduction: [
    ...
    'The current PDF tools cover fill-and-sign editing with highlights, freehand annotations, images and stamps, PDF page conversion to JPG or PNG, and text-layer extraction to TXT. Each tool uses explicit file, page, pixel, and memory limits because browser-local processing trades cloud uploads for the resources available on your own device. Keep the original file, especially for important documents.',
  ],
  questionsAnswered: [
    'Can I sign, annotate or add an image to a PDF without uploading the document?',
  ...
  toolDescriptions: [
    { slug: 'pdf-sign-edit', description: 'Open a PDF locally, place fill-and-sign marks, highlights, freehand drawings, PNG/JPEG images and reviewed stamps, then export a flattened edited copy from the browser.' },
  ...
  choosingTools: [
    'Use PDF Sign & Edit when the goal is to fill, sign or annotate an existing PDF while keeping the document content in the browser. You can place highlights, freehand drawings, PNG/JPEG images and reviewed stamps in addition to signing marks. Keep a separate original because the exported copy is flattened rather than intended as a fully editable source document.',
