...
const coreTools: Tool[] = [
  ...
  tool('roas', 'ROAS Calculator', 'Calculate return on ad spend from advertising cost and attributed revenue.', 'Business', 'business', ['roas', 'return on ad spend', 'advertising', 'marketing']),
  tool('conversion-rate', 'Conversion Rate Calculator', 'Calculate the percentage of visitors, leads, or opportunities that convert.', 'Business', 'business', ['conversion rate', 'conversions', 'marketing', 'sales']),
  tool('cpc', 'CPC Calculator', 'Calculate average advertising cost per click from spend and recorded clicks.', 'Business', 'business', ['cpc', 'cost per click', 'advertising', 'marketing']),
  tool('cpm', 'CPM Calculator', 'Calculate advertising cost per one thousand impressions from spend and impressions.', 'Business', 'business', ['cpm', 'cost per thousand', 'impressions', 'advertising']),
  tool('customer-acquisition-cost', 'Customer Acquisition Cost Calculator', 'Calculate average customer acquisition cost from acquisition spend and new customers.', 'Business', 'business', ['cac', 'customer acquisition cost', 'marketing', 'customers']),
