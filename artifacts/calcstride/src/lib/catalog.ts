...
const coreTools: Tool[] = [
  ...
  tool('date-difference', 'Date Duration Calculator', 'Count days between dates or add and subtract calendar years, months, weeks, and days.', 'Date & Time', 'date-time', ['date duration', 'days between dates', 'date calculator', 'day counter calculator', 'date add subtract', 'time between dates', 'date difference', 'calendar duration', 'weeks between dates'], true),
