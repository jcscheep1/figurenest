...
export const phaseFourRoutes: readonly PhaseFourCatalogEntry[] = [
  ...
  { slug: 'shoe-size', href: '/converters/shoe-size', name: 'Shoe Size Converter', description: 'Compare approximate adult US, UK, and EU shoe sizes while keeping region, adult scope, and brand variation clear.', category: 'Converters', categorySlug: 'converters', tags: ['shoe conversion', 'US UK EU shoe size'] },
