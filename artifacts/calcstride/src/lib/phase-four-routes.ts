...
export const phaseFourRoutes: readonly PhaseFourCatalogEntry[] = [
  { slug: 'mileage', href: '/calculators/automotive/mileage', name: 'Mileage Calculator', description: 'Calculate fuel economy from a trip distance you enter yourself and fuel consumed; this page does not route, map, or geocode travel.', category: 'Automotive & EV', categorySlug: 'automotive', tags: ['trip MPG', 'fuel mileage'] },
  ...
  { slug: 'shoe-size', href: '/converters/shoe-size', name: 'Shoe Size Converter', description: 'Compare approximate US, UK, and EU shoe sizes for babies, toddlers, children, youth, women, and men using age-group-specific reference tables and foot-length guidance.', category: 'Converters', categorySlug: 'converters', tags: ['shoe conversion', 'US UK EU shoe size', 'kids shoe size', 'children shoe size', 'toddler shoe size'] },
