...
export const toolApplicability: Record<string, ToolApplicability> = {
  'pdf-sign-edit': unitless(), 'pdf-to-image': unitless(), 'image-to-pdf': unitless(), 'pdf-to-text': unitless(), 'docx-to-pdf': unitless(), 'pdf-to-docx': unitless(), 'csv-to-xlsx': unitless(), 'xlsx-to-csv': unitless(), 'xlsx-to-pdf': unitless(), 'image-converter': unitless(),
