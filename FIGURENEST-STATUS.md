...
| FN-005 | P1 | Calculator functional audit | 🟠 ACTIVE | One-by-one production test of every calculator: inputs, units, validation, formulas, result rendering, mobile usability | Current issue register A-O is fully closed; use `FIGURENEST-FUNCTIONAL-AUDIT.md` as the calculator-by-calculator cursor and do not retest completed rows |
