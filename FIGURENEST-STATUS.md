...
| FN-005 | P1 | Calculator functional audit | 🟠 ACTIVE | One-by-one production test of every calculator: inputs, units, validation, formulas, result rendering, mobile usability | Current issue register A-T is fully closed; use `FIGURENEST-FUNCTIONAL-AUDIT.md` as the calculator-by-calculator cursor and do not retest completed rows |
...
| FN-005-N | Loan Calculator | Blank required principal, rate, or term fields were coerced to zero and could produce plausible results | ✅ CLOSED | Shared required-field finance guard added in `634fb659ed74a2061f681ba027e6308c45586089`; full calculator suite/typecheck passed; all Vercel checks green; live Chrome run `34268276394` confirmed blank principal, rate, and term are each rejected while zero rate remains valid |
| FN-005-O | Loan Calculator | Non-month-aligned terms such as 5.01 years were accepted as fractional monthly payment periods | ✅ CLOSED | Whole-month Basic/Advanced validation and one-month UI stepping added in `634fb659ed74a2061f681ba027e6308c45586089`; live Chrome run `34268276394` rejected 5.01 years, accepted 5.5 years / 66 months, confirmed step `0.08333333333333333`, and Advanced mode rejected the same invalid term |
| FN-005-P | Investment Calculator | Extreme finite investment inputs could overflow compound-growth arithmetic and render `$∞` instead of an error | ✅ CLOSED | Finite-result guard and regression merged in `c9923462763dcdadc70a8322a24459bff53f8ec6`; typecheck, SEO generation, 409/409 unit tests and production build passed; all Vercel deployment statuses green; live Chrome run `34269010115` on 2026-09-08 confirmed normal `$34,570.43`, zero-return `$25,000.00`, blank/negative validation, fractional-year support, overflow rejection, mobile/a11y, internal links and SEO/content checks |
| FN-005-Q | Mortgage Calculator | Non-month-aligned terms such as 30.01 years were accepted in Basic mode as fractional monthly payment periods while the Advanced amortization contract uses whole months | ✅ CLOSED | Basic whole-month validation and one-month UI stepping added in `ac3d33a2cd58854d183c92daf36ee1ba7acc92fc`; guarded full calculator suite and typecheck passed; Vercel main deployment green; live Chrome run `34269240781` on 2026-09-08 confirmed normal `$2,345.36`, zero-rate and invalid-input behavior, 30.01 years rejected, 30.5 years / 366 months accepted, one-month UI step, and Advanced rejecting the same non-month-aligned term |
| FN-005-R | 401(k) Growth Calculator | Fractional projection years were accepted even though contributions and compounding are modeled annually | ✅ CLOSED | Whole-year validation and `step=1` added in `c08c67cfefeccd81c4db541b8f5808e0655bfc76`; regression/validation passed; Vercel deployments green; live Chrome run `34270949462` on 2026-09-08 confirmed `$558,391.07` at 6%/20y, fractional 20.5y rejection, and `$285,000.00` at 0% |
| FN-005-S | Bond Calculator | Fractional maturity years were accepted despite the calculator using annual coupon periods | ✅ CLOSED | Annual-period validation, min 1 and `step=1` added in `78069e95af50015ab1645743c902750d0dc908ec`; validation workflow passed; live Chrome run `34270949462` on 2026-09-08 confirmed `$1,081.11` at 10y and rejected 10.5y |
| FN-005-T | Compound Interest Calculator | Zero-year and non-month-aligned horizons such as 10.01 years were accepted as continuous/fractional monthly periods | ✅ CLOSED | Basic/Advanced whole-month horizon repair deployed in `9d333728283b642fc9a84bacacc3463fe5966f91`; 418/418 regression tests, typecheck and full build passed; all three Vercel checks green; live Chrome run `34270949462` on 2026-09-08 confirmed `$50,066.82` normal result, zero-year rejection, 10.01y rejection, 10.5y acceptance and one-month UI step |
