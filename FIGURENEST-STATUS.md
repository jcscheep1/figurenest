...
| FN-005 | P1 | Calculator functional audit | 🟠 ACTIVE | One-by-one production test of every calculator: inputs, units, validation, formulas, result rendering, mobile usability | Current issue register A-K is fully closed; continue only from genuinely unaudited calculators and add child IDs only for new confirmed failures |
